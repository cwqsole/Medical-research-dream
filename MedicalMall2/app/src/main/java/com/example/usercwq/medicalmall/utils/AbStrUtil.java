...
public class AbStrUtil {
    ...
    public static void textColor(TextView tv, int num) {
        SpannableStringBuilder builder = new SpannableStringBuilder(tv.getText().toString());
        ForegroundColorSpan redSpan = new ForegroundColorSpan(MyLication.myLication.getColor(R.color.colorTabText));
...
//    /**
//     * 收藏
//     * isColl true收藏，false取消收藏
//     */
//    public static void Collect(Context context, TextView tv, boolean isColl) {
//        Drawable rightDrawable;
//        if (isColl) {
//            rightDrawable = context.getResources().getDrawable(R.drawable.ic_collection_hl);
//        } else {
//            rightDrawable = context.getResources().getDrawable(R.drawable.ic_collection_nor);
//        }
